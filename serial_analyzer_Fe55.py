...
def Run(tfilename,tfnoisename,tfo,histos):
    ...
    for evt in ttree:
        ...
        ### if(n_active_planes!=len(cfg["detectors"])): continue ### CUT!!! ###TODO: cannot require this for Fe55...
        ### histos["h_cutflow"].Fill( cfg["cuts"].index("N_{hits/det}>0") ) ###TODO: cannot require this for Fe55...
        ...
        ### if(nclusters!=len(cfg["detectors"])): continue ### CUT!!! ###TODO: cannot require this for Fe55...
        ### histos["h_cutflow"].Fill( cfg["cuts"].index("N_{cls/det}==1") ) ###TODO: cannot require this for Fe55...
        for det in cfg["detectors"]:
            fillClsHists(det,clusters[det],masked[det],histos)
            ### histos["h_cls_3D"].Fill( clusters[det][0].xmm,clusters[det][0].ymm,clusters[det][0].zmm ) ###TODO: I disabled this for Fe55...
        
        continue ###TODO: I added this for Fe55...
