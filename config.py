...
class Config:
    ...
    def set(self,fname,doprint=False):
        ...
        self.add("lut_nbinsx_0200", self.getI('LUT','lut_nbinsx_0200'))
        self.add("lut_nbinsy_0200", self.getI('LUT','lut_nbinsy_0200'))
        self.add("lut_nbinsx_4000", self.getI('LUT','lut_nbinsx_4000'))
        self.add("lut_nbinsy_4000", self.getI('LUT','lut_nbinsy_4000'))
        ...
        self.add("lut_widthx_0020", self.getF('LUT','lut_widthx_0020'))
        self.add("lut_widthy_0020", self.getF('LUT','lut_widthy_0020'))
        self.add("lut_widthx_0200", self.getF('LUT','lut_widthx_0200'))
        self.add("lut_widthy_0200", self.getF('LUT','lut_widthy_0200'))
        self.add("lut_widthx_4000", self.getF('LUT','lut_widthx_4000'))
        self.add("lut_widthy_4000", self.getF('LUT','lut_widthy_4000'))
